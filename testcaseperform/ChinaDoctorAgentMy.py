...
case_name = "ChinaDoctorAgentMy"

@ddt.ddt
class ChinaDoctorAgentMy(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_ChinaDoctorAgentMy(self,data):
        #测试报告用于说明
        ...
        #对结果特殊处理下
        expectedreport = self.disposespecialhandle.ChinaDoctorAgentMySpecial(expectedreport)
        #断言
        try: 
            #返回状态断言
