...
from common import DisposeCase,DisposeApi,DisposeHeader,DisposeReport,RunMain,DisposeRely,DisposeAssert,DisposeEnv,DisposeSpecial
import os
import time

case_name = "UserInvitation"

@ddt.ddt
class UserInvitation(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_UserInvitation(self,data):
        #测试报告用于说明
